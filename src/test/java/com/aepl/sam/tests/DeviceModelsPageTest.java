...
public class DeviceModelsPageTest extends TestBase implements DeviceModelConstants {
	 ...
	 * dynamic so it does not able to validate the actual and expected data
	 * 
	 * NOTE : modify in future
	 * 
	 * NOTE : Create a random string for creating new model and store it in new
	 * variable which we can use it further for search that perticular model. so it
	 * does not able to validate the actual and expected data
	 *
	 * NOTE : modify in future
	 *
	 */
